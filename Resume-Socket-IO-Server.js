 ...
 * @type {Object}
 * @property {Socket} socket Socket.IO from io.on("connection", (socket) => {   });
 ...
 * @param {Resume-REST-API-Connect~Transcript} transcript Transcript response of sent sound from Resume API
 */
/**
 * The callback Resume API response that the session ended
 ...
 * @param {string} sessionID Resume SessionID
 * @param {(int|string)} sectionId ID of section e.g. department number, section of organization name, given from ResumeOne().newSession(...)
 * @param {Resume-REST-API-Connect~ResumeSoundInfo} info Information from Resume.js client to sent to Resume API
 */
 ...
 * @param {Server} [io] Socket.IO Server object  - const io = require("socket.io")();
...
module.exports = { BindSIO: BindSIO, SIOOnConnection: SIOOnConnection, OptionBindSIO: OptionBindSIO, OptionSIO: OptionSIO };